        ...
        <div class="col-md-8 offset-md-1">
            <div class="head row">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <span class="align-right mr-1"><a href="{{ route('shop.index', ['category'=> request()->category, 'tag'=> request()->tag, 'sort' => 'low_high']) }}" class="hover-color-blue price-filter text-decoration-none {{ request()->sort == 'low_high' ? 'active-sort' : '' }}">Low to High</a></span>|
                    <span class="align-right"><a href="{{ route('shop.index', ['category'=> request()->category, 'tag'=> request()->tag, 'sort' => 'high_low']) }}" class="hover-color-blue price-filter text-decoration-none {{ request()->sort == 'high_low' ? 'active-sort' : '' }}">High to Low</a></span>
                </div>
            </div>
            <!-- start products row -->
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 col-lg-4 product">
                    <a href="{{ route('shop.show', $product->slug) }}" class="custom-card">
                        <div class="card view overlay zoom">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">{{ $product->name }}<br><span class="float-right">$ {{ format($product->price) }}</span></h5>
